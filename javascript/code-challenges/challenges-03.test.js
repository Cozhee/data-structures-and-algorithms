...
const typeNum = (arr) => {
  // Solution code here...
  const newArr = []
  arr.filter(num => !isNaN(num) ? newArr.push(num) : null)
  return newArr
};
...
const containsAnd = (arr) => {
  ...
  const newArr = []
  const term = 'and'
  arr.filter(word => word.includes(term) ? newArr.push(word) : null)
  return newArr
};
...
const oddValues = (arr) => {
  // Solution code here...
  const newArr = []
  arr.filter(num => num % 2 == 1 ? newArr.push(num) : null)
  return newArr
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  const newArr = []
  arr.filter(item => !forbiddenValues.includes(item) ? newArr.push(item) : null)
  return newArr
};
